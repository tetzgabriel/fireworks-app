...
- **Soccer Game Integration:** Automatically highlights dates for major Brazilian soccer championships (Brasileirão, Estaduais) and National Team games, as these events are frequent sources of fireworks.
...
- `lib/services/soccer_service.dart`: Service to generate/fetch soccer game schedules.
